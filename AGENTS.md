# ETH Global Online 2025 AI駆動開発 共通ガイドライン

## 全体的な方針
- 特段の指定がない限り、わかりやすくて自然な日本語で回答を出力してください

## ETH Global Online 2025のハッカソンについての特別な要件
- このハッカソンは2025年10月10日から31日にかけて行われるオンラインハッカソンです。
- 審査員の方が確認しやすいようにコミット時にはわかりやすいコメントを英語で生成してください
- 狙うプライズは、Avail、PayPal、hardhatの3つです。
- Availのプライズ要件はNexus SDKを使うことです。
- PayPalのプライズ要件はPYUSDを使うことです。
- hardhatのプライズ要件はhardhat V3を使うことです。
